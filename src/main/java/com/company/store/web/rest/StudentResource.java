...
import com.company.store.domain.Student;
import com.company.store.repository.StudentRepository;
...
/**
 * REST controller for managing {@link com.company.store.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
